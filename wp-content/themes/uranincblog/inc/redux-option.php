...
$opt_name = 'uranincblog_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'About', 'uranincblog' ),
        'id'         => 'about',
        'subsection'=>true,
        'fields'     => array(
            array(
                'id'       => 'abouttext',
                'type'     => 'text',
                'title'    => esc_html__( 'Textarea Option - HTML Validated Custom', 'uranincblog' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'title', 'uranincblog' ),
        'id'         => 'title',
        'subsection'=>true,
        'fields'     => array(
            array(
